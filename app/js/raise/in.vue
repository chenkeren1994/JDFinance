        ...
        <section :class="$style.content">
            <div v-for="item in items" :class="$style.item" :key="item.catory">
                ...
                <section :class="$style.list">
                    <div v-for="subItem in item.list" :class="$style.product" :key="subItem.title">
                        <img :src="subItem.img" alt="">
                        <p :class="$style.title">{{subItem.title}}</p>
                        <p :class="$style.price"><em>{{subItem.price}}</em>起</p>
                        <article>
                            <div :class="$style.wrapper">
                                <div :class="$style.inner" :style="{width: subItem.progress + '%'}"></div>
                            </div>
                            <p>{{subItem.progress}}%</p>
                        </article>
                        <label v-show="subItem.choice">精选</label>
                    </div>
                </section>
            </div>
        </section>
